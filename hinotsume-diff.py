# python difframe.py crop0.mp4 ref0.png 240 82340 flag0.avi
# python difframe.py crop1.mp4 ref1.png 0 82430 flag1.avi
...
temp= ref
vsize= ref.shape
videoout = cv2.VideoWriter(sys.argv[5],cv2.VideoWriter_fourcc(*'MP4V'), 60.0, (vsize[0] ,vsize[1]) )
