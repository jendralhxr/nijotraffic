			...
			# apply identifier
				...
				if (block_start >= gate_left) and (block_end <= gate_right):
					...
					if (image_prev[3,int((block_start + block_end)/2) ][2] != 0) :
						...
						cv2.rectangle(image_display, start_point, end_point, (255,36,12), 2)
					...
					if (image_prev[5, int((block_start + block_end)/2) ][2] != 0) :
						...
						start_point = (block_start, 8) 
						end_point = (block_end, 72) 
						label_point= (block_start+10, 60)
						cv2.rectangle(image_display, start_point, end_point, (12,36,255), 2)
